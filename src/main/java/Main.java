...
public class Main {
    ...
    private static void inputNumber() {
        ...
        int col = runUntilGetValidadeNumber(0, 8);
        System.out.println("Informe a linha em que o número sera inserido");
        int row = runUntilGetValidadeNumber(0, 8);
        System.out.printf("Informe o número que vai entrar na posição {%s, %s}: \n", col, row);
        int value = runUntilGetValidadeNumber(1,9);
    ...
    private static int runUntilGetValidadeNumber(final int min, final int max){
